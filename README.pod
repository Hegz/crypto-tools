...
L<Autokey Cipher|http://en.wikipedia.org/wiki/Autokey_cipher>.  I have plans to
implement other Tabula Rectas at a later date.
...
B=2,C=3 etc.  Thus a string 'helloworld' becomes 'hxhadisdus'.
